 ...
 * Copyright (c) 2021-2022, Martin Wendt. Released under the MIT license.
 * v0.1.1, Sun, 27 Nov 2022 07:35:11 GMT (https://github.com/mar10/wunderbaum)
 */const QUICKSEARCH_DELAY=500;class KeynavExtension extends WunderbaumExtension{constructor(e){super(e,"keynav",{})}_getEmbeddedInputElem(e){var t;let i=null;if(e&&null!=e.type)i=e;else{const e=null===(t=this.tree.getActiveColElem())||void 0===t?void 0:t.querySelector("input,select");e&&(i=e)}return i}_isCurInputFocused(){var e;const t=null===(e=this.tree.getActiveColElem())||void 0===e?void 0:e.querySelector("input:focus,select:focus");return console.log("_isCurInputFocused",t),!!t}onKeyEvent(e){const t=e.event,i=this.tree,s=e.options,n=!t.ctrlKey||s.autoActivate,r=this._getEmbeddedInputElem(t.target),o=s.navigationModeOption;let l,a=eventToString(t),d=e.node,c=!0;if(!i.isEnabled())return!1;if(!1===i._callEvent("keydown",e))return!1;if(!1===i._callMethod("edit._preprocessKeyEvent",e))return!1;if(!d){const e=i.getFocusNode()||i.getActiveNode(),t=i.getFirstChild();if(!e&&t&&"ArrowDown"===a)return t.logInfo("Keydown: activate first node."),void t.setActive();l=e||t,l&&(l.setFocus(),d=i.getFocusNode(),d.logInfo("Keydown: force focus on active node."))}const h=d.isColspan();if(i.isRowNav()){if(s.quicksearch&&1===a.length&&/^\w$/.test(a)&&!r){const e=Date.now();e-i.lastQuicksearchTime>500&&(i.lastQuicksearchTerm=""),i.lastQuicksearchTime=e,i.lastQuicksearchTerm+=a;let s=i.findNextNode(i.lastQuicksearchTerm,i.getActiveNode());return s&&s.setActive(!0,{event:t}),void t.preventDefault()}switch(a){case"Enter":d.isActive()&&(d.isExpanded()?a="Subtract":d.isExpandable(!0)&&(a="Add"));break;case"ArrowLeft":d.expanded&&(a="Subtract");break;case"ArrowRight":if(!d.expanded&&d.isExpandable(!0))a="Add";else if(o===NavModeEnum.startCell||o===NavModeEnum.startRow)return t.preventDefault(),i.setCellNav(),!1}switch(a){case"+":case"Add":d.setExpanded(!0);break;case"-":case"Subtract":d.setExpanded(!1);break;case" ":d.getOption("checkbox")?d.setSelected(!d.isSelected()):d.setActive(!0,{event:t});break;case"Enter":d.setActive(!0,{event:t});break;case"ArrowDown":case"ArrowLeft":case"ArrowRight":case"ArrowUp":case"Backspace":case"End":case"Home":case"Control+End":case"Control+Home":case"Meta+ArrowDown":case"Meta+ArrowUp":case"PageDown":case"PageUp":d.navigate(a,{activate:n,event:t});break;default:c=!1}}else{const e=this._getEmbeddedInputElem(null),s=e?e.type||e.tagName:"",r=e&&this._isCurInputFocused(),l=e&&"checkbox"!==s;if(r){if("Escape"===a)d.render();else if("Enter"!==a)return void d.logDebug(`Ignored ${a} inside focused input`)}else if(e&&1===a.length&&l)return e.focus(),e.value="",d.logDebug(`Focus imput: ${a}`),!1;switch("Tab"===a?(a="ArrowRight",c=!0):"Shift+Tab"===a&&(a=i.activeColIdx>0?"ArrowLeft":"",c=!0),a){case"+":case"Add":d.setExpanded(!0);break;case"-":case"Subtract":d.setExpanded(!1);break;case" ":0===i.activeColIdx&&d.getOption("checkbox")?(d.setSelected(!d.isSelected()),c=!0):e&&"checkbox"===s&&(e.click(),c=!0);break;case"F2":e&&!r&&l&&(e.focus(),c=!0);break;case"Enter":i.setFocus(),(0===i.activeColIdx||h)&&d.isExpandable()?(d.setExpanded(!d.isExpanded()),c=!0):e&&!r&&l&&(e.focus(),c=!0);break;case"Escape":i.setFocus(),i.isCellNav()&&o!==NavModeEnum.cell&&(i.setCellNav(!1),c=!0);break;case"ArrowLeft":i.setFocus(),h&&d.isExpanded()?d.setExpanded(!1):!h&&i.activeColIdx>0?i.setColumn(i.activeColIdx-1):o!==NavModeEnum.cell&&i.setCellNav(!1),c=!0;break;case"ArrowRight":i.setFocus(),h&&!d.isExpanded()?d.setExpanded():!h&&i.activeColIdx<i.columns.length-1&&i.setColumn(i.activeColIdx+1),c=!0;break;case"Home":i.setFocus(),!h&&i.activeColIdx>0&&i.setColumn(0),c=!0;break;case"End":i.setFocus(),!h&&i.activeColIdx<i.columns.length-1&&i.setColumn(i.columns.length-1),c=!0;break;case"ArrowDown":case"ArrowUp":case"Backspace":case"Control+End":case"Control+Home":case"Meta+ArrowDown":case"Meta+ArrowUp":case"PageDown":case"PageUp":d.navigate(a,{activate:n,event:t}),c=!0;break;default:c=!1}}c&&t.preventDefault()}}
/*!
