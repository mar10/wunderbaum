 ...
 * Copyright (c) 2021-2022, Martin Wendt. Released under the MIT license.
 * v0.0.6, Sat, 10 Sep 2022 19:29:21 GMT (https://github.com/mar10/wunderbaum)
 */const DEFAULT_DEBUGLEVEL=4,ROW_HEIGHT=22,ICON_WIDTH=20,ROW_EXTRA_PAD=7,RENDER_MAX_PREFETCH=5,TEST_IMG=new RegExp(/\.|\//);let iconMap={error:"bi bi-exclamation-triangle",loading:"bi bi-chevron-right wb-busy",noData:"bi bi-question-circle",expanderExpanded:"bi bi-chevron-down",expanderCollapsed:"bi bi-chevron-right",expanderLazy:"bi bi-chevron-right wb-helper-lazy-expander",checkChecked:"bi bi-check-square",checkUnchecked:"bi bi-square",checkUnknown:"bi dash-square-dotted",radioChecked:"bi bi-circle-fill",radioUnchecked:"bi bi-circle",radioUnknown:"bi bi-circle-dotted",folder:"bi bi-folder2",folderOpen:"bi bi-folder2-open",doc:"bi bi-file-earmark"};const RESERVED_TREE_SOURCE_KEYS=new Set(["children","columns","format","keyMap","positional","typeList","types","version"]),INPUT_BREAKOUT_KEYS=new Set(["Enter","Escape"]),KEY_TO_ACTION_DICT={" ":"toggleSelect","+":"expand",Add:"expand",ArrowDown:"down",ArrowLeft:"left",ArrowRight:"right",ArrowUp:"up",Backspace:"parent","/":"collapseAll",Divide:"collapseAll",End:"lastCol",Home:"firstCol","Control+End":"last","Control+Home":"first","Meta+ArrowDown":"last","Meta+ArrowUp":"first","*":"expandAll",Multiply:"expandAll",PageDown:"pageDown",PageUp:"pageUp","-":"collapse",Subtract:"collapse"};function makeNodeTitleMatcher(e){return e=escapeRegex(e.toLowerCase()),function(t){return t.title.toLowerCase().indexOf(e)>=0}}function makeNodeTitleStartMatcher(e){e=escapeRegex(e);const t=new RegExp("^"+e,"i");return function(e){return t.test(e.title)}}
/*!
 * Wunderbaum - ext-keynav
 * Copyright (c) 2021-2022, Martin Wendt. Released under the MIT license.
 * v0.0.6, Sat, 10 Sep 2022 19:29:21 GMT (https://github.com/mar10/wunderbaum)
 */const QUICKSEARCH_DELAY=500;class KeynavExtension extends WunderbaumExtension{constructor(e){super(e,"keynav",{})}_getEmbeddedInputElem(e){var t;let i=null;if(e&&null!=e.type)i=e;else{const e=null===(t=this.tree.getActiveColElem())||void 0===t?void 0:t.querySelector("input,select");e&&(i=e)}return i}_isCurInputFocused(){var e;const t=null===(e=this.tree.getActiveColElem())||void 0===e?void 0:e.querySelector("input:focus,select:focus");return console.log("_isCurInputFocused",t),!!t}onKeyEvent(e){const t=e.event,i=this.tree,s=e.options,n=!t.ctrlKey||s.autoActivate,r=this._getEmbeddedInputElem(t.target),o=s.navigationModeOption;let l,a=eventToString(t),d=e.node,c=!0;if(i.log(`onKeyEvent: ${a}, curInput`,r),!i.isEnabled())return!1;if(!1===i._callEvent("keydown",e))return!1;if(!1===i._callMethod("edit._preprocessKeyEvent",e))return!1;if(!d){const e=i.getFocusNode()||i.getActiveNode(),t=i.getFirstChild();if(!e&&t&&"ArrowDown"===a)return t.logInfo("Keydown: activate first node."),void t.setActive();l=e||t,l&&(l.setFocus(),d=i.getFocusNode(),d.logInfo("Keydown: force focus on active node."))}const h=d.isColspan();if(i.isRowNav()){if(s.quicksearch&&1===a.length&&/^\w$/.test(a)&&!r){const e=Date.now();e-i.lastQuicksearchTime>500&&(i.lastQuicksearchTerm=""),i.lastQuicksearchTime=e,i.lastQuicksearchTerm+=a;let s=i.findNextNode(i.lastQuicksearchTerm,i.getActiveNode());return s&&s.setActive(!0,{event:t}),void t.preventDefault()}switch(a){case"ArrowLeft":d.expanded&&(a="Subtract");break;case"ArrowRight":if(d.expanded||!d.children&&!d.lazy){if(o===NavigationOptions.startRow)return void i.setCellNav()}else a="Add"}switch(a){case"+":case"Add":d.setExpanded(!0);break;case"-":case"Subtract":d.setExpanded(!1);break;case" ":d.getOption("checkbox")?d.setSelected(!d.isSelected()):d.setActive(!0,{event:t});break;case"Enter":d.setActive(!0,{event:t});break;case"ArrowDown":case"ArrowLeft":case"ArrowRight":case"ArrowUp":case"Backspace":case"End":case"Home":case"Control+End":case"Control+Home":case"Meta+ArrowDown":case"Meta+ArrowUp":case"PageDown":case"PageUp":d.navigate(a,{activate:n,event:t});break;default:c=!1}}else{const e=this._getEmbeddedInputElem(null),s=e?e.type||e.tagName:"",r=e&&this._isCurInputFocused(),l=e&&"checkbox"!==s;if(r){if("Escape"===a)d.render();else if(!INPUT_BREAKOUT_KEYS.has(a))return void d.logDebug(`Ignored ${a} inside input`)}else if(e&&1===a.length&&l)return e.focus(),e.value="",d.logDebug(`Focus imput: ${a}`),!1;switch("Tab"===a?(a="ArrowRight",c=!0):"Shift+Tab"===a&&(a=i.activeColIdx>0?"ArrowLeft":"",c=!0),a){case" ":0===i.activeColIdx&&d.getOption("checkbox")?(d.setSelected(!d.isSelected()),c=!0):e&&"checkbox"===s&&(e.click(),c=!0);break;case"F2":e&&!r&&l&&(e.focus(),c=!0);break;case"Enter":i.setFocus(),0===i.activeColIdx&&d.isExpandable()?(d.setExpanded(!d.isExpanded()),c=!0):e&&!r&&l&&(e.focus(),c=!0);break;case"Escape":i.setFocus(),i.isCellNav()&&o!==NavigationOptions.cell&&(i.setCellNav(!1),c=!0);break;case"ArrowLeft":i.setFocus(),h&&d.isExpanded()?d.setExpanded(!1):i.activeColIdx>0?(i.setColumn(i.activeColIdx-1),c=!0):o!==NavigationOptions.cell&&(i.setCellNav(!1),c=!0);break;case"ArrowRight":i.setFocus(),h&&!d.isExpanded()?d.setExpanded():i.activeColIdx<i.columns.length-1&&(i.setColumn(i.activeColIdx+1),c=!0);break;case"ArrowDown":case"ArrowUp":case"Backspace":case"End":case"Home":case"Control+End":case"Control+Home":case"Meta+ArrowDown":case"Meta+ArrowUp":case"PageDown":case"PageUp":d.navigate(a,{activate:n,event:t}),c=!0;break;default:c=!1}}c&&t.preventDefault()}}
/*!
