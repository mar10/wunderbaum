...
/*!
   ...
   * Copyright (c) 2021-2023, Martin Wendt. Released under the MIT license.
   * v0.5.1, Sat, 16 Sep 2023 19:08:55 GMT (https://github.com/mar10/wunderbaum)
   */class ne extends O{constructor(e){super(e,"grid",{}),this.observer=new se({root:window.document,selector:"span.wb-col-resizer",thresh:4,dragstart:e=>this.tree.element.contains(e.dragElem),drag:e=>this.handleDrag(e),dragstop:e=>this.handleDrag(e)})}init(){super.init()}handleDrag(e){const t=he.getEventInfo(e.event);this.tree.log(`${e.type}(${e.dx})`,e,t)}}
/*!
   * Wunderbaum - deferred
   * Copyright (c) 2021-2023, Martin Wendt. Released under the MIT license.
   * v0.5.1, Sat, 16 Sep 2023 19:08:55 GMT (https://github.com/mar10/wunderbaum)
