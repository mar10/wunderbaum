...
/*!
   ...
   * Copyright (c) 2021-2023, Martin Wendt. Released under the MIT license.
   * v0.4.0, Wed, 06 Sep 2023 08:21:56 GMT (https://github.com/mar10/wunderbaum)
   */!function(e){e.any="any",e.data="data",e.colStructure="colStructure",e.resize="resize",e.row="row",e.structure="structure",e.status="status",e.scroll="scroll"}(I||(I={})),function(e){e.clearMarkup="clearMarkup",e.header="header",e.redraw="redraw",e.scroll="scroll"}(L||(L={})),function(e){e.ok="ok",e.loading="loading",e.error="error",e.noData="noData"}(D||(D={})),function(e){e.unknown="",e.checkbox="checkbox",e.column="column",e.expander="expander",e.icon="icon",e.prefix="prefix",e.title="title"}(M||(M={})),function(e){e.startRow="startRow",e.cell="cell",e.startCell="startCell",e.row="row"}(A||(A={}));
/*!
