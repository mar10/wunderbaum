...
/*!
   ...
   */const $="object"==typeof global&&null!==global&&global.Object===Object&&global,P="object"==typeof globalThis&&null!==globalThis&&globalThis.Object==Object&&globalThis,R="object"==typeof self&&null!==self&&self.Object===Object&&self,F=P||$||R||Function("return this")();function z(e){const t=typeof e;return null!=e&&("object"===t||"function"===t)}function U(e,t=0,i={}){let s,n,r,l,o,a,d=0,c=!1,h=!1,u=!0;const p=!t&&0!==t&&"function"==typeof F.requestAnimationFrame;if("function"!=typeof e)throw new TypeError("Expected a function");function f(t){const i=s,r=n;return s=n=void 0,d=t,l=e.apply(r,i),l}function g(e,t){return p?(F.cancelAnimationFrame(o),F.requestAnimationFrame(e)):setTimeout(e,t)}function v(e){const i=e-a;return void 0===a||i>=t||i<0||h&&e-d>=r}function m(){const e=Date.now();if(v(e))return b(e);o=g(m,function(e){const i=e-d,s=t-(e-a);return h?Math.min(s,r-i):s}(e))}function b(e){return o=void 0,u&&s?f(e):(s=n=void 0,l)}function y(...e){const i=Date.now(),r=v(i);if(s=e,n=this,a=i,r){if(void 0===o)return function(e){return d=e,o=g(m,t),c?f(e):l}(a);if(h)return o=g(m,t),f(a)}return void 0===o&&(o=g(m,t)),l}return t=+t||0,z(i)&&(c=!!i.leading,h="maxWait"in i,r=h?Math.max(+i.maxWait||0,t):r,u="trailing"in i?!!i.trailing:u),y.cancel=function(){void 0!==o&&function(e){if(p)return F.cancelAnimationFrame(e);clearTimeout(e)}(o),d=0,s=a=n=o=void 0},y.flush=function(){return void 0===o?l:b(Date.now())},y.pending=function(){return void 0!==o},y}
/*!
...
/*!
   ...
   * Copyright (c) 2021-2023, Martin Wendt. Released under the MIT license.
   * v0.5.2, Mon, 09 Oct 2023 18:32:56 GMT (https://github.com/mar10/wunderbaum)
   */class re extends O{constructor(e){super(e,"grid",{}),this.observer=new ne({root:window.document,selector:"span.wb-col-resizer",thresh:4,dragstart:e=>this.tree.element.contains(e.dragElem),drag:e=>this.handleDrag(e),dragstop:e=>this.handleDrag(e)})}init(){super.init()}handleDrag(e){const t=ue.getEventInfo(e.event);this.tree.log(`${e.type}(${e.dx})`,e,t)}}
/*!
   * Wunderbaum - deferred
   * Copyright (c) 2021-2023, Martin Wendt. Released under the MIT license.
   * v0.5.2, Mon, 09 Oct 2023 18:32:56 GMT (https://github.com/mar10/wunderbaum)
